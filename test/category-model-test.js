...
import { musicCategory, testCategories } from "./fixtures.js";
...
suite("Category Model tests", () => {
  ...
  test("create a category", async () => {
    const category = await db.categoryStore.addCategory(musicCategory);
    assertSubset(musicCategory, category);
